...
<template>
    <section class="action-section-left mx-4 md:mr-32 md:ml-0 border-4 border-l-0 border-[var(--accent)] rounded-r-[60px] p-5 md:p-12 bg-white">
              ...
              <div class="action-content flex-1 flex flex-col gap-4 order-2 md:order-1 w-full">
                  <div v-for="(item, index) in items" :key="index" 
                      ...
                      <div :ref="el => items[index].container = el" 
                           class="overflow-hidden bg-white px-8 font-clementeMini"
