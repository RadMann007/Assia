...
<template>
    <section class="action-section-left mx-4 md:mr-32 md:ml-0 border-4 border-l-0 border-[var(--accent)] rounded-r-[var(--border-radius-primary)] p-5 md:p-12 bg-white ">
