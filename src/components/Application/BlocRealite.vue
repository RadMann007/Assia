  ...
  <section class="pb-10 flex flex-col gap-6 items-stretch bg-white w-full">
    <div class="flex flex-col gap-6 w-full mx-auto">
      ...
      <div class="font-clemente relative mb-8 text-slate-700 w-full">
        ...
        <div @click="toggleCollapse(0)" class="relative z-20 py-6 px-10 md:py-8 md:px-16 mx-4 md:mx-10 lg:mx-20 flex justify-center items-center select-none bg-orange-400 text-white rounded-[40px] shadow-md cursor-pointer hover:bg-orange-500 transition-colors">
          <h3 class="text-xl md:text-3xl font-black uppercase tracking-tight text-center">Une réalité partagée par de nombreuses associations</h3>
          <div class="absolute right-6 md:right-10 w-10 h-10 flex items-center justify-center text-4xl font-light transition-transform duration-300" :style="{ transform: activeCollapse === 0 ? 'rotate(45deg)' : 'rotate(0deg)' }">+</div>
        </div>

        <!-- Content : Reste en 100% width (w-full) et sans arrondis (rounded-none) -->
        <div :ref="el => contentRefs[0] = el" class="collapse-content relative z-10 overflow-hidden bg-[#FFF5F0] rounded-none -mt-10 shadow-lg h-0 opacity-0 w-full">
          <div class="px-6 md:px-12 lg:px-20 pb-0 pt-14 flex flex-col gap-10">
            <div class="flex justify-center -mt-4 mb-2">
               <svg width="40" height="20" viewBox="0 0 40 20" fill="none">
                <path d="M2 2L20 18L38 2" stroke="#fb923c" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>

            <div class="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
              <div class="flex-1 text-[#00A3B5]">
                <p class="mb-6 font-bold text-lg md:text-xl leading-relaxed">Sur le terrain, les équipes font face à :</p>
                <ul class="space-y-4">
                  <li class="flex items-start gap-3">
                    <span class="text-2xl leading-none mt-1 text-orange-400">•</span>
                    <p class="text-lg leading-tight font-medium">des outils pensés pour le reporting, pas pour l'accompagnement social</p>
                  </li>
                  <li class="flex items-start gap-3">
                    <span class="text-2xl leading-none mt-1 text-orange-400">•</span>
                    <p class="text-lg leading-tight font-medium">des interfaces complexes et chronophages</p>
                  </li>
                  <li class="flex items-start gap-3">
                    <span class="text-2xl leading-none mt-1 text-orange-400">•</span>
                    <p class="text-lg leading-tight font-medium">une multiplication de saisies et d'outils annexes</p>
                  </li>
                  <li class="flex items-start gap-3">
                    <span class="text-2xl leading-none mt-1 text-orange-400">•</span>
                    <p class="text-lg leading-tight font-medium">des difficultés à produire des indicateurs sans dénaturer la pratique</p>
                  </li>
                  <li class="flex items-start gap-3">
                    <span class="text-2xl leading-none mt-1 text-orange-400">•</span>
                    <p class="text-lg leading-tight font-medium">une faible appropriation des outils par les professionnels</p>
                  </li>
                </ul>
              </div>
              <div class="flex-1 w-full flex justify-center">
                <img src="/img/meet2.avif" alt="Illustration" class="w-full max-w-md h-[300px] object-cover rounded-[30px] shadow-sm border-white" />
              </div>
            </div>
            ...
            <div class="bg-[#00A3B5] -mx-6 md:-mx-12 lg:-mx-20 p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 text-white">
              <div class="flex-1 w-full">
                <img src="/img/ordi1.png" alt="Mockup ASSIA" class="w-full h-auto drop-shadow-2xl transform -rotate-1" />
              </div>
      ...
      <div class="font-clemente relative mb-8 text-slate-700 w-full">
        <!-- Header avec marge -->
        <div @click="toggleCollapse(1)" class="relative z-20 py-6 px-10 md:py-8 md:px-16 mx-4 md:mx-10 lg:mx-20 flex justify-center items-center select-none bg-orange-400 text-white rounded-[40px] shadow-md cursor-pointer hover:bg-orange-500 transition-colors">
          <h3 class="text-xl md:text-3xl font-black uppercase tracking-tight text-center">Quand un besoin devient collectif, la mutualisation fait sens</h3>
          <div class="absolute right-6 md:right-10 w-10 h-10 flex items-center justify-center text-4xl font-light transition-transform duration-300" :style="{ transform: activeCollapse === 1 ? 'rotate(45deg)' : 'rotate(0deg)' }">+</div>
        </div>

        <!-- Content Full Width -->
        <div :ref="el => contentRefs[1] = el" class="collapse-content relative z-10 overflow-hidden bg-[#FFF5F0] rounded-none -mt-10 shadow-lg h-0 opacity-0 w-full">
          <div class="px-6 md:px-12 lg:px-20 pb-16 pt-14 flex flex-col gap-10">
            <div class="flex justify-center -mt-4 mb-2">
               <svg width="40" height="20" viewBox="0 0 40 20" fill="none"><path d="M2 2L20 18L38 2" stroke="#fb923c" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </div>
            <div class="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
              <div class="flex-1 text-[#00A3B5]">
              ...
              <div class="flex-1 w-full flex justify-center">
                <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2968&auto=format&fit=crop" alt="Illustration" class="w-full max-w-md h-[300px] object-cover rounded-[30px] shadow-sm rotate-1 border-4 border-white" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="font-clemente relative mb-8 text-slate-700 w-full">
        <div @click="toggleCollapse(2)" class="relative z-20 py-6 px-10 md:py-8 md:px-16 mx-4 md:mx-10 lg:mx-20 flex justify-center items-center select-none bg-orange-400 text-white rounded-[40px] shadow-md cursor-pointer hover:bg-orange-500 transition-colors">
          <h3 class="text-xl md:text-3xl font-black uppercase tracking-tight text-center">
            UN PRODUIT CO-CONSTRUIT AVEC LES PROFESSIONNELS
          </h3>
          <div class="absolute right-6 md:right-10 w-10 h-10 flex items-center justify-center text-4xl font-light transition-transform duration-300" :style="{ transform: activeCollapse === 2 ? 'rotate(45deg)' : 'rotate(0deg)' }">+</div>
        </div>

        <div :ref="el => contentRefs[2] = el" class="collapse-content relative z-10 overflow-hidden bg-[#FFF5F0] rounded-none -mt-10 shadow-lg h-0 opacity-0 w-full">
          <div class="px-6 md:px-12 lg:px-20 pb-16 pt-14 flex flex-col gap-10">
            ...
            <div class="flex flex-col md:flex-row gap-8 md:gap-16 items-start max-w-7xl mx-auto">
              ...
              <div class="flex-1 w-full flex justify-center md:justify-end">
                <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2968&auto=format&fit=crop" alt="Co-construction" class="w-full max-w-sm h-auto object-cover rounded-[40px] shadow-sm border-4 border-white" />
              </div>
            </div>
